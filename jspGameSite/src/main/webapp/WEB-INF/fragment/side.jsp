				...
				<div class="swiper swiper2">
					<div class="swiper-wrapper">
						...
						<div class="swiper-slide">
							<a href="../news/eventDetail?id=<%= eventList.get(i).getId() %>&commentPage=1"><img class="event-img" id="event-img" src="<%=eventList.get(i).getImage() %>" style="width: 285px; height: 120px"></a>
